...
- Under about 300 KB each so pages stay quick.

If a file is missing the card falls back to the person's initials, so an
incomplete set is fine — add photos as people send them.
